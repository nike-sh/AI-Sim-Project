        ...
        if (changeState)
        {
            switch (state)
            {
                ...
                case AIStates.patrol:
                    ...
                    //Tank goes into patrol looking for Enemy when Enemy bases are destroyed
                ...
                case AIStates.attack:
                    ...
                    else if(GetAmmo < 4) // tank looks for more ammo if GetAmmo is low
                    {
                        state = AIStates.patrol;
                        changeState = false;
                    }
                ...
                case AIStates.defendBase:
                    ...
                    //if no bases are left tank goes into patrol state
